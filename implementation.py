...
def test_manacher():
    s1 = "abcba"
    print(f"Test Case 1: {manacher(s1)}")

    s2 = "abaxyzzyxf"
    print(f"Test Case 2: {manacher(s2)}")

    s3 = "xyzracecarabc"
    print(f"Test Case 3: {manacher(s3)}")

    s4 = "fgjijkllkjljgf"
    print(f"Test Case 4: {manacher(s4)}")

    s5 = "abacdfgdcabbaabcdedcba"
    print(f"Test Case 5: {manacher(s5)}")
